...
class GraceInAuburnSnippets_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'grace-in-auburn-snippets'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'grace-in-auburn-snippets'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'grace-in-auburn-snippets'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'grace-in-auburn-snippets'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'grace-in-auburn-snippets');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'grace-in-auburn-snippets'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'grace-in-auburn-snippets');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'grace-in-auburn-snippets'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'grace-in-auburn-snippets') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'grace-in-auburn-snippets');
            case 'false':
                return __('false', 'grace-in-auburn-snippets');

            case 'Administrator':
                return __('Administrator', 'grace-in-auburn-snippets');
            case 'Editor':
                return __('Editor', 'grace-in-auburn-snippets');
            case 'Author':
                return __('Author', 'grace-in-auburn-snippets');
            case 'Contributor':
                return __('Contributor', 'grace-in-auburn-snippets');
            case 'Subscriber':
                return __('Subscriber', 'grace-in-auburn-snippets');
            case 'Anyone':
                return __('Anyone', 'grace-in-auburn-snippets');
        }
        return $optionValue;
    }
